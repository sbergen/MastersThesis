...
\draw[dashed,gray!50]
	...
	node [midway, above, gray] {\footnotesize $v < v_{thresh}$};
...
%	(\XOffset + 0.5 * \TickLength, \StillTop + \SafetyMargin);
%\draw [opacity=0] (\XOffset, \StillBottom) -- (\XOffset, \StillTop)
%	node [opacity=1,black,midway,left] {$\Delta y_i$};
...
\draw
	...
	(\BottomTime, \MotionBottom) node[above,gray] {$y_{min}$} to[out=0,in=180]
