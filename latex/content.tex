...
\fixme{Make times dynamic, describe this better?}

The first feature is a filtered peak velocity.
...
\fixme{Revise once the method use is final, current text is obsolete!}
...
An addition parameter, which does not affect the patch selection,
...
The architecture was designed largely
based on the the
