...
heuristics to extract data \cite{},
...
\item The system should be usable by anyone familiar with conducting with minimal instruction.
...
(discussed in more detail in section \ref{})
