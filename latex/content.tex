...
both laboratory and musical rehearsal situations.
...
While the average tempo may be even across a piece of music,
...
have been developed.
Expressive timing is a feature
that can be added to a score file,
and is thus not necessarily a task the conductor follower has to perform.
The most relevant point regarding expressive timing, however,
is its tempo dependence --
phrase timing will differ depending on the absolute tempo.
...
\fixme{Write overview, mention possible use in pedagogical purposes.}
...
\fixme{
Discuss further score analysis,
tempo curves (considered harmful),
further motion and gesture sutff...
}
