...
\end{cases}
\end{equation}
where $y_i$ is the value of the function at time $i$.
...
\begin{enumerate}
\item Musical time has the base unit of beats, but it also includes a time varying derived unit of bars. Any position in the score can thus be expressed as either a beat offset, or a combination of bars and beats. Its dimension is denoted with $B$ and quantities with $b$.
