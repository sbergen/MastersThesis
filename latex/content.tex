...
which forms the limit for how old a tempo estimate can be,
...
\end{equation}
where $\Delta t_{b1,2}$ is the time between the first and second conducted beat,
...
\fixme{These need to be reimplemented!}
