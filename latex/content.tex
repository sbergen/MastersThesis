...
it can be easily used to detect local minima and maxima (peaks and dips).
...
\end{cases}
\end{equation}
where $P_i$ is the type of peak or dip detected,
and $y_i$ the value of the function at time $i$.
